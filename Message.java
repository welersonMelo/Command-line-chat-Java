...
public final class Message {
  ...
  public interface MensagemOrBuilder extends
     ...
     * <code>.Conteudo conteudo = 5;</code>
     */
    Message.Conteudo getConteudo();
    /**
     * <code>.Conteudo conteudo = 5;</code>
     */
    Message.ConteudoOrBuilder getConteudoOrBuilder();
  }
  /**
  ...
  public  static final class Mensagem extends
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 42: {
              Message.Conteudo.Builder subBuilder = null;
              if (conteudo_ != null) {
                subBuilder = conteudo_.toBuilder();
              }
              conteudo_ = input.readMessage(Message.Conteudo.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    private Message.Conteudo conteudo_;
    /**
     * <code>.Conteudo conteudo = 5;</code>
     */
     ...
     * <code>.Conteudo conteudo = 5;</code>
     */
    public Message.Conteudo getConteudo() {
      return conteudo_ == null ? Message.Conteudo.getDefaultInstance() : conteudo_;
    }
    /**
     * <code>.Conteudo conteudo = 5;</code>
     */
    public Message.ConteudoOrBuilder getConteudoOrBuilder() {
      return getConteudo();
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof Message.Mensagem)) {
        return super.equals(obj);
      }
      Message.Mensagem other = (Message.Mensagem) obj;
  ...
  checkByteStringIsUtf8(value);
      ...
      private Message.Conteudo conteudo_ = null;
      private com.google.protobuf.SingleFieldBuilderV3<
          Message.Conteudo, Message.Conteudo.Builder, Message.ConteudoOrBuilder> conteudoBuilder_;
      /**
       * <code>.Conteudo conteudo = 5;</code>
       */
      public boolean hasConteudo() {
       ...
       * <code>.Conteudo conteudo = 5;</code>
       */
      public Builder setConteudo(Message.Conteudo value) {
        if (conteudoBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setConteudo(
          Message.Conteudo.Builder builderForValue) {
        if (conteudoBuilder_ == null) {
       ...
       * <code>.Conteudo conteudo = 5;</code>
       */
      public Builder mergeConteudo(Message.Conteudo value) {
        if (conteudoBuilder_ == null) {
          if (conteudo_ != null) {
            conteudo_ =
              Message.Conteudo.newBuilder(conteudo_).mergeFrom(value).buildPartial();
          } else {
            conteudo_ = value;
          }
          onChanged();
       ...
       * <code>.Conteudo conteudo = 5;</code>
       */
      public Message.Conteudo.Builder getConteudoBuilder() {
      ...
      public Message.ConteudoOrBuilder getConteudoOrBuilder() {
        if (conteudoBuilder_ != null) {
          ...
          return conteudo_ == null ?
              Message.Conteudo.getDefaultInstance() : conteudo_;
        }
      }
      /**
       * <code>.Conteudo conteudo = 5;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          Message.Conteudo, Message.Conteudo.Builder, Message.ConteudoOrBuilder> 
    ...
    private static final Message.Mensagem DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new Message.Mensagem();
    }

    public static Message.Mensagem getDefaultInstance() {
  ...
  public  static final class Conteudo extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return Message.internal_static_Conteudo_descriptor;
    }

    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return Message.internal_static_Conteudo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              Message.Conteudo.class, Message.Conteudo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof Message.Conteudo)) {
        return super.equals(obj);
      }
      Message.Conteudo other = (Message.Conteudo) obj;
    ...
    public static Message.Conteudo parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static Message.Conteudo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Message.Conteudo parseFrom(
    ...
    public static Message.Conteudo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static Message.Conteudo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static Message.Conteudo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(Message.Conteudo prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() {
      return this == DEFAULT_INSTANCE
    ...
    public static final class Builder extends
      ...
      // Construct using Message.Conteudo.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public Message.Conteudo getDefaultInstanceForType() {
        return Message.Conteudo.getDefaultInstance();
      }

      public Message.Conteudo build() {
        Message.Conteudo result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public Message.Conteudo buildPartial() {
        Message.Conteudo result = new Message.Conteudo(this);
        result.tipo_ = tipo_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof Message.Conteudo) {
          return mergeFrom((Message.Conteudo)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(Message.Conteudo other) {
        if (other == Message.Conteudo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        Message.Conteudo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (Message.Conteudo) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final Message.Conteudo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new Message.Conteudo();
    }

    public static Message.Conteudo getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
